...
/**
 * `Psr\HttpMessage\MessageInterface` 接口实现
 *
...
abstract class Message implements MessageInterface
{
     ...
     * @var string[]
     */
    protected static array $supportedProtocolVersions = ['1.0', '1.1', '2.0', '2'];
     ...
     * @param string $mode
     */
    protected function registerStream($stream, string $mode = 'wb+'): void
    {
     ...
     * @throws InvalidArgumentException for invalid HTTP protocol version.
     */
    protected function registerProtocolVersion(string $protocol): void
    {
     ...
     * @throws InvalidArgumentException for invalid HTTP protocol version.
     */
    protected function validateProtocolVersion($protocol): void
    {
